...
const VideoCarousel = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to("#slider", {
      ...
      duration: 2,
      ease: "power2.inOut", // Mostrar el visualizer https://gsap.com/docs/v3/Eases
    });

    // UNa animacion para reproducir el video cuando está en la vista
    gsap.to("#video", {
      scrollTrigger: {
        trigger: "#video",
      ...
      let anim = gsap.to(span[videoId], {
        onUpdate: () => {
          ...
          if (progress != currentProgress) {
            ...
            // setea el ancho de la barra de progreso
            ...
            // setea el color de fondo de la barra de progreso
  ...
  // vd id es el id de cada video hasta que id se convierte en el número 3
